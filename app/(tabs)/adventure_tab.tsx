...
export default function Adventure() {
  ...
  // Hides the floating bottom tab bar the whole time this tab is focused
  // (matches the pill bar's tabBarStyle from app/(tabs)/_layout.tsx), and
  // restores it automatically when leaving the Adventure tab. adventure_tab
  // is a direct child screen of the Tabs navigator, so `navigation` here is
  // already scoped to that Tabs navigator — no getParent() needed.
  useFocusEffect(
    useCallback(() => {
